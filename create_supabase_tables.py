...
# -*- coding: utf-8 -*-
"""
Создание таблиц на Supabase напрямую
"""
...
def create_supabase_tables():
    ...
    try:
        ...
        print("\nСоздание таблиц на Supabase завершено!")
        print("Теперь Alembic сможет работать с существующими таблицами!")
...
if __name__ == "__main__":
    print("Создание таблиц на Supabase")
    print("=" * 50)
